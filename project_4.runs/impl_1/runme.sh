...
HD_PWD='D:/vlsi-projekat/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log final_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source final_uart.tcl -notrace
