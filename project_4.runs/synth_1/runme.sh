...
HD_PWD='D:/vlsi-projekat/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source final_uart.tcl
